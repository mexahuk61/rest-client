...
namespace RestDotNet
{
    public static class ResponseExtensions
    {
        ...
        {
            restRequest.RegisterCallback(HttpStatusCode.OK, action);
            return restRequest.ExecuteAsync(cancellationToken);
        }
        ...
        {
            restRequest.RegisterCallback(HttpStatusCode.BadRequest, action);
            return restRequest;
        }
        ...
        {
            restRequest.RegisterCallback(HttpStatusCode.NotFound, action);
            return restRequest;
        }
        ...
        {
            restRequest.RegisterCallback(HttpStatusCode.InternalServerError, action);
            return restRequest;
        }
        ...
        {
            restRequest.RegisterCallback(HttpStatusCode.Forbidden, action);
            return restRequest;
        }
        ...
        {
            restRequest.RegisterCallback(HttpStatusCode.Conflict, action);
            return restRequest;
        }
